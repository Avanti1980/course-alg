...
@import "../tikz/max-flow/max-flow.svg" {.center .top2 .width80}
...
@import "../tikz/max-flow/max-flow2.svg" {.right25 .lefta .top-45per .width40}
...
@import "../tikz/max-flow/max-flow-para-edge.svg" {.center .top4 .width80}
...
@import "../tikz/max-flow/max-flow-multiple-st.svg" {.center .top4 .width50}
...
@import "../tikz/max-flow/max-flow-cut.svg" {.center .top2 .width40}
...
@import "../tikz/max-flow/max-flow-min-cut.svg" {.center .top4 .width50}
...
@import "../tikz/max-flow/max-flow-res-net.svg" {.center .top4 .width90}
...
@import "../tikz/max-flow/max-flow-aug2.svg" {.center .top4 .width90}
...
@import "../tikz/max-flow/max-flow-aug.svg" {.center .top2 .width60}
...
@import "../tikz/max-flow/max-flow-inefficient.svg" {.center .top4 .width52}
...
@import "../codes/max-flow/ford-fulkerson.py" {line_begin=198 line_end=236 .left4 .line-numbers .top1 .bottom4 highlight=[]}
...
@import "../tikz/max-flow/max-flow-irrational.svg" {.center .top2 .width70}
...
@import "../tikz/max-flow/max-flow-irrational2.svg" {.center .top2 .width70}
...
@import "../tikz/max-flow/max-flow-decomposition.svg" {.center .top4 .bottom-2 .width75}
...
每轮迭代：以$s$为根结点生长树$\Tcal$，不断向$\Tcal$中加入残存容量最大的边 (化用 Dijkstra 算法)，直至$\Tcal$中包含从$s$到$t$的路径，时间复杂度为$O(|\Ecal|\lg|\Ecal|) = O(|\Ecal|\lg|\Vcal|)$
...
Alexander Karzanov 同时证明了单位容量流网络中的流分解时间复杂度是$O(\min\{ |\Vcal|^{2/3}, |\Ecal|^{1/2} \} |\Ecal|)$，因此和前面的下界$\Omega(|\Vcal| |\Ecal|)$不矛盾
...
@import "../tikz/max-flow/max-flow-vertex-cap.svg" {.center .top4 .bottom-2 .width80}
...
@import "../tikz/max-flow/max-flow-vertex-disjoint.svg" {.center .top4 .bottom-2 .width80}
...
匹配：无向图$\Gcal = (\Vcal, \Ecal)$的匹配 (matching) 是边的子集$\Mcal \subseteq \Ecal$，使得对$\forall v$，子集$\Mcal$中最多只有一条边与$v$相连

最大匹配：若$\Mcal$是最大匹配，则对任意匹配$\Mcal'$有$|\Mcal| \ge |\Mcal'|$

@import "../tikz/max-flow/matching.svg" {.center .top4 .width45}
...
@import "../tikz/max-flow/matching-max-flow.svg" {.center .top5 .width70}
...
一方面，任意匹配$\Mcal$可以转化为一个可行的流$f_{\Mcal}$：对任意边$(u,v) \in \Mcal$，在路径$s \rightarrow u \rightarrow v \rightarrow t$上运输单位流量，因此最大匹配$\le$最大流
...
@import "../tikz/max-flow/matching-alter-path.svg" {.center .top4 .width80 .bottom-10}
...
@import "../tikz/max-flow/disjoint-path-cover.svg" {.center .top6 .bottom4 .width80}
...
@import "../tikz/max-flow/disjoint-path-cover2.svg" {.center .top4 .bottom4 .width80}
