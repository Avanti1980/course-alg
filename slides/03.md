...
@import "../codes/cut-rod.py" {line_begin=4 line_end=12 .left4 .line-numbers .top0 .bottom0 highlight=[7]}
...
@import "../codes/cut-rod.py" {line_begin=24 line_end=40 .left4 .line-numbers .top1 .bottom0 highlight=[2,7]}
...
@import "../codes/cut-rod.py" {line_begin=42 line_end=50 .left4 .line-numbers .top1 .bottom0 highlight=[2,7]}
...
@import "../codes/cut-rod.py" {line_begin=52 line_end=65 .left4 .line-numbers .top0 .bottom0 highlight=[3,9,11-14]}
...
@import "../codes/matrix-chain.py" {line_begin=3 line_end=15 .left4 .line-numbers .top-2 .bottom0 highlight=[7]}
...
@import "../codes/matrix-chain.py" {line_begin=27 line_end=50 .left4 .line-numbers .top0 .bottom0}
...
@import "../dot/binary-search-tree-example.dot" {.left5 .top0 .bottom0}
...
如果$T$是关于$k_1, k_2, \ldots, k_n$和$d_0, d_1, \ldots, d_n$的 OBST，则$T$中仅包含$k_i, \ldots, k_j$的子树$T'$必然是关于$k_i, \ldots, k_j$和$d_{i-1}, \ldots, d_j$的 OBST
...
设$e[i,j]$是仅包含$k_i, \ldots, k_j$的 OBST 的期望搜索代价

<div class="top-2"></div>

根据最优子结构性，一旦从$k_i, \ldots, k_j$中确定根结点$k_r$

- 左子树仅包含$k_i, \ldots, k_{r-1}$且是 OBST
- 右子树仅包含$k_{r+1}, \ldots, k_j$且是 OBST

@import "../dot/binary-search-tree-proof.dot" {.left58per .top-8}
...
$e[i,j]$是仅包含$k_i, \ldots, k_j$的 OBST 的期望搜索代价，结点概率和

$$
\begin{align*}
    \quad w(i,j) = \sum_{l=i}^j p_l + \sum_{l=i-1}^j q_l
\end{align*}
$$
