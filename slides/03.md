...
@import "../codes/cut-rod.py" {line_begin=52 line_end=67 .left4 .line-numbers .top1 .bottom0 highlight=[3,9,11-14]}
...
$$
\begin{align*}
    \quad \overline{\Av_i \cdots \Av_j}^\star = \overline{\Av_i \cdots \Av_k} \cdot \overline{\Av_{k+1} \cdots \Av_j}
\end{align*}
$$
...
- $\overline{\Av_i \cdots \Av_k} = \overline{\Av_i \cdots \Av_k}^\star$，否则$\overline{\Av_i \cdots \Av_k}^\star \cdot \overline{\Av_{k+1} \cdots \Av_j}$优于$\overline{\Av_i \cdots \Av_j}^\star$
...
@import "../codes/matrix-chain.py" {line_begin=4 line_end=16 .left4 .line-numbers .top-2 .bottom0 highlight=[7]}
...
$m[1,6] = 15125$即为计算$\Av_1 \cdots \Av_6$的最优加括号方案的乘法次数
...
@import "../codes/matrix-chain.py" {line_begin=18 line_end=26 .left4 .line-numbers .top0 .bottom0}
...
@import "../codes/matrix-chain.py" {line_begin=28 line_end=51 .left4 .line-numbers .top0 .bottom0}
