...
<p class="fragment comments"> 和动态规划不同，贪心法每轮贪心选择后只产生一个子问题：选文件集合中长度最短的文件</p>
...
<p class="fragment">尾递归 => 迭代，一重 for 循环时间复杂度$\Theta(n)$</p>

@import "../codes/activity-selector.py" {line_begin=9 line_end=17 .left4 .line-numbers .top-2 .bottom0 .fragment}
...
引理：$\{a_m\} \cup \Acal_m$就是$\Scal_k$的最大兼容活动集合
