...
贪心选择：从$\Vcal \setminus \Scal$中选择最短路径{==估计值==}$\widetilde{\delta}$最小的结点加入$\Scal$

$\widetilde{\delta}(s,s) = 0$、$\widetilde{\delta}(s,y) = \widetilde{\delta}(s,t) = \widetilde{\delta}(s,x) = \widetilde{\delta}(s,z) = \infty$
...
- $\widetilde{\delta}(s,t) = \infty \rightarrow \widetilde{\delta}(s,s) = \delta(s,y) + w(s,t) = 0 + 10 = 10$
- $\widetilde{\delta}(s,y) = \infty \rightarrow \widetilde{\delta}(s,y) = \delta(s,y) + w(s,y) = 0 + 5 = 5$
- $\widetilde{\delta}(s,x) = \widetilde{\delta}(s,z) = \infty$
...
- $\widetilde{\delta}(s,t) = 10 \rightarrow \widetilde{\delta}(s,t) = \delta(s,y) + w(y,t) = 5 + 3 = 8$
- $\widetilde{\delta}(s,x) = \infty \rightarrow \widetilde{\delta}(s,x) = \delta(s,y) + w(y,x) = 5 + 9 = 14$
- $\widetilde{\delta}(s,z) = \infty \rightarrow \widetilde{\delta}(s,z) = \delta(s,y) + w(y,z) = 5 + 2 = 7$
