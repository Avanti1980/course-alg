...
@import "../dot/subset-sum-example-fix-len.dot" {.center .top0}
...
@import "../codes/subset-sum-fix-len.py" {line_begin=0 line_end=48 .left4 .line-numbers .top0}
...
@import "../dot/subset-sum-example-var-len.dot" {.center .top0}

<div class="top-40per left6per fs16">
...
@import "../codes/subset-sum-var-len.py" {line_begin=0 line_end=32 .left4 .line-numbers .top0}
