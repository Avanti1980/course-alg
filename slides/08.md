...
##### <span style="font-weight:800">n</span>-皇后问题
...
##### <span style="font-weight:800">4</span>-皇后问题初试
...
##### <span style="font-weight:800">4</span>-皇后 状态空间树
...
##### <span style="font-weight:800">4</span>-皇后问题 回溯求解
...
##### <span style="font-weight:800">n</span>-皇后问题 回溯实现

---

@import "../codes/backtrack-bb/nqueen.py" {line_begin=0 line_end=52 .left4 .line-numbers .top0}
...
@import "../codes/backtrack-bb/hamilton.py" {line_begin=0 line_end=85 .left4 .line-numbers .top0}
...
@import "../codes/backtrack-bb/subset-sum-fix-len.py" {line_begin=0 line_end=49 .left4 .line-numbers .top0}
