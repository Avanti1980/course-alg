...
{==定长==}$4$元组$(x_1, x_2, x_3, x_4)$，$x_i \in \{1, 0\}$表示是否选$w_i$，16 个叶结点对应 16 个可能的解，其到根结点的路径为该解对应的元组

@import "../dot/subset-sum-sol-space.dot" {.center .top3 .bottom-3}
...
@import "../codes/subset-sum.py" {line_begin=0 line_end=49 .left4 .line-numbers .top0}
