...
##### <span style="font-weight:800">Algorithm</span>一词的由来
...
@import "../codes/intro/integer-multiplication.py" {line_begin=9 line_end=35 .left4 .line-numbers .top0 highlight=[4,7]}
...
<p class="fragment">$n$位数相乘的原问题 => $3$个$n/2$位数相乘的子问题，递归实现</p>
...
@import "../codes/intro/integer-multiplication.py" {line_begin=37 line_end=82 .left4 .line-numbers .top0 highlight=[19-21,37]}

<!-- slide vertical=true data-notes="" -->

##### <span style="font-weight:800">Karatsuba</span>算法 计算量
...
$$
\begin{align*}
    \quad x \cdot y = a \cdot c \cdot 10^n + ((a+b) \cdot (c+d) - a \cdot c - b \cdot d) 10^{n/2} + b \cdot d
\end{align*}
$$

$n$位数相乘的原问题 => $3$个$n/2$位数相乘的子问题

设$n$位数相乘的计算量为$T(n)$，加法计算量不超过$10n$
...
@import "../codes/intro/integer-multiplication.py" {line_begin=84 .left4 .line-numbers .top0 highlight=[]}
...
@import "../codes/intro/integer-multiplication.svg" {.center .width75 .top2 .bottom-4}
