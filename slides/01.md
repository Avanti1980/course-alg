...
- 不妨设$a \ge b$，记$a / b = q \cdots r$且$r < q$，于是$\gcd(a,b) \mid r$
...
@import "../codes/gcd.py" {line_begin=21 line_end=29 .left4 .line-numbers .bottom0}
...
@import "../codes/gcd.py" {line_begin=31 line_end=44 .left4 .line-numbers .top-1 .bottom0}
