...
\begin{align*}
    ...
    & \quad \Longrightarrow \underbrace{T(n) + 1}_{G(n)} = \underbrace{T(n-1) + 1}_{G(n-1)} + \underbrace{T(n-2) + 1}_{G(n-2)}, \ldots, G(0) = G(1) = 2 \\[10pt]
    & \quad \Longrightarrow G(n) = 2 F(n+1) \\[10pt]
    & \quad \Longrightarrow T(n) = 2 F(n+1) - 1
\end{align*}
$$
...
@import "../codes/cut-rod.py" {line_begin=26 line_end=40 .left4 .line-numbers .top1 .bottom0 highlight=[2,7]}
