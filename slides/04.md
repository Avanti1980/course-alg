...
<p class="fragment">最长路径的两个子问题不独立，子问题 ①=>② 的最长路径经过的点，在子问题 ②=>③ 的最长路径中不能再经过，否则构成环，换言之子问题 ①=>② 的求解影响了子问题 ②=>③ 的求解</p>
...
<p class="fragment"><i class="fa fa-lightbulb-o"></i> 可否考虑序列的第一个元素和后缀？</p>
