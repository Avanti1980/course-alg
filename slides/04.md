...
@import "../codes/fibo.py" {line_begin=7 line_end=19 .left4 .line-numbers .top0 .bottom2 highlight=[2,10-11]}
...
@import "../codes/fibo.py" {line_begin=21 line_end=27 .left4 .line-numbers .top0 highlight=[4-5]}
...
@import "../codes/fibo.py" {line_begin=29 line_end=35 .left4 .line-numbers .top0 .bottom2}
...
@import "../codes/fibo.py" {line_begin=37 line_end=49 .left4 .line-numbers .top0 .bottom2}
...
5. 若除最优解的值外还需最优解本身，在第 2 步里维护一些额外信息
