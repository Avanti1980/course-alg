...
问题归约：若$\Gcal$的所有边的权重为正整数，将权重为$l$的边分解成$l$个长度为$1$的边，得到无权图$\Gcal'$，对$\Gcal'$运行`bfs_sssp`算法
...
##### 有向无环图 <span style="font-weight:800">DAG</span>
...
##### 无权图 <span style="font-weight:800">DAG</span>
...
##### <span style="font-weight:800">Bellman-Ford</span> 填表
...
@import "../codes/sssp/bellman-ford.py" {line_begin=0 line_end=11 .left4 .line-numbers .top1 .bottom1}

内层二重 for 循环其实是遍历所有边，时间复杂度$\Theta(|\Vcal||\Ecal|)$

<!-- slide vertical=true data-notes="" -->

##### <span style="font-weight:800">Bellman-Ford</span> 例子

---

$\quad \small |\Vcal|=5, ~ d_v^{(k)} = \begin{cases} \infty, & k = 0 \\ \min \{ d_v^{(k-1)}, ~ \min_{u \ne v} \{ d_u^{(k-1)} + w(u,v) \} \}, & k \ge 1 \end{cases}$

@import "../tikz/sssp/sp-bellman-ford.svg" {.center .width90 .top4 .bottom-4}

<!-- slide vertical=true data-notes="" -->

##### <span style="font-weight:800">Bellman-Ford</span> 负环检测
...
$$
\begin{align*}
    \quad 0 & = \sum_{k=i}^{j-1} \delta(s,v_{k+1}) - \sum_{k=i}^{j-1} \delta(s,v_k) \overset{\text{三角不等式}}{\le} ~ \sum_{k=i}^{j-1} w(v_k,v_{k+1}) \overset{\text{负环}}{<} 0
\end{align*}
$$
...
##### <span style="font-weight:800">Bellman-Ford</span> 实现

---

@import "../codes/sssp/bellman-ford-dp.py" {line_begin=0 line_end=36 .left4 .line-numbers .top0 highlight=[8,11-12]}

<!-- slide data-notes="" -->

##### <span style="font-weight:800">Bellman-Ford</span> 说明
...
@import "../codes/sssp/bellman-ford-dp-example.py" {line_begin=0 line_end=68 .left4 .line-numbers .top0 highlight=[8,11-12]}
...
@import "../codes/sssp/bellman-ford-compare.py" {line_begin=0 line_end=84 .left4 .line-numbers .top0 highlight=[8,11,25]}

<!-- slide vertical=true data-notes="" -->

##### <span style="font-weight:800">Bellman-Ford</span> 小结
...
@import "../tikz/sssp/sp-bellman-ford-final.svg" {.lefta .right8 .width35 .top-10}

<!-- slide data-notes="" -->

##### <span style="font-weight:800">Dijkstra</span> 算法
...
@import "../tikz/sssp/sp-2.svg" {.lefta .right8 .width40 .top-8}
...
@import "../tikz/sssp/sp-dijkstra-1.svg" {.lefta .right8 .width40 .top-8}
...
@import "../tikz/sssp/sp-dijkstra-2.svg" {.lefta .right8 .width40 .top-2}

<!-- slide data-notes="" -->

##### <span style="font-weight:800">Dijkstra</span> 例子

---

@import "../tikz/sssp/sp-dijkstra.svg" {.center .width92 .top4}
...
##### <span style="font-weight:800">Dijkstra</span> 正确性
...
@import "../tikz/sssp/dijkstra-proof.svg" {.lefta .right4 .width35 .top-8}
...
@import "../tikz/sssp/dijkstra-proof.svg" {.lefta .right4 .width35 .top-10}

<!-- slide data-notes="" -->

##### <span style="font-weight:800">Dijkstra</span> 负边
...
@import "../tikz/sssp/difference-constraints.svg" {.left42per .width48 .top-35per}
...
@import "../tikz/sssp/difference-constraints2.svg" {.left42per .width50 .top-34per}
