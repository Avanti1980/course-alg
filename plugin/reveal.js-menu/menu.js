!(function (e, t) {
  ...
  return (
    ...
    function () {
      ...
      function L() {
        var e = window.getComputedStyle(O(".reveal p"));
        O(".slide-menu").style.fontFamily = e.fontFamily;
        O(".slide-menu").style.fontWeight = e.fontWeight;
      }
      var T = 0;
      function C() {
        if (!a) {
          ...
          O(".slide-menu").appendChild(d),
            e("导航", "Slides", "fa-images", "fas", S, !0),
            r.themes && e("主题", "Themes", "fa-adjust", "fas", S),
            r.transitions &&
              e("动画", "Transitions", "fa-sticky-note", "fas", S),
              r.custom &&
          ...
          if (
            ...
            p.appendChild(k("br")),
            p.appendChild(
              k("span", { class: "slide-menu-toolbar-label" }, "关闭")
            ),
            (p.onclick = function () {
              g(null, !0);
            }),
